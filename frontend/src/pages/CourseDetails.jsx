...
const CourseDetails = () => {
  ...
  const courseReviews = reviewData?.filter((review) => review.course?._id?.toString() === courseId?.toString());
      ...
      <div className="grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div className="space-y-4">
          ...
          {isEnroll ? (
            ...
            <button
              onClick={() => (!userData ? navigate("/signup") : handleEnroll(userData._id, courseId))}
